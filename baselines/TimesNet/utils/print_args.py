def print_args(args):
    ...
    if getattr(args, 'model', None) == 'macbook':
        print(f'  {"Patch Len:":<20}{args.patch_len:<20}{"Patch Stride:":<20}{args.macbook_patch_stride:<20}')
        print(f'  {"Num Groups:":<20}{args.macbook_num_groups:<20}{"Num Banks:":<20}{args.macbook_num_banks:<20}')
        print(f'  {"Num Slots:":<20}{args.macbook_num_slots:<20}{"Route Top-r:":<20}{args.macbook_route_topr:<20}')
        print(f'  {"Code Dim:":<20}{args.macbook_code_dim:<20}{"Backbone L:":<20}{args.macbook_backbone_layers:<20}')
        print(f'  {"Adapter L:":<20}{args.macbook_adapter_layers:<20}{"Adapter Rank:":<20}{args.macbook_adapter_rank:<20}')
        print(f'  {"Adapter Scale:":<20}{args.macbook_adapter_scale:<20}')
    print()
