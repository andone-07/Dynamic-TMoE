...
do
    python -u run_longExp.py \
      ...
      --train_epochs 1\
      --gpu 0\
      --itr 1 --batch_size $batch_size --learning_rate $learning_rate >logs/LongForecasting/exchange/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_'$T_num_expert'_'$T_top_k'_'$F_num_expert'_'$F_top_k'_'$learning_rate'_0.1'.log
done
done
done
done
