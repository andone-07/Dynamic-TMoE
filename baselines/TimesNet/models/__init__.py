...
from . import WPMixer, MultiPatchFormer, KANAD, MSGNet, TimeFilter, DycNet, pearl, pearl_v2, Poem
from . import macbook
...
__all__ = [
    ...
    'WPMixer', 'MultiPatchFormer', 'KANAD', 'MSGNet', 'TimeFilter', 'DycNet', 'pearl', 'pearl_v2', 'Poem', 'macbook',
